...
typedef NS_ENUM(NSUInteger, JSMessageInputViewStyle) {
    ...
    /**
     *  A photo button with input view.
     */
    JSMessageInputViewStylePhoto
...
/**
 *  The media button for the input view. The default value is an initialized `UIButton` whose appearance is styled according to the value of style during initialization.
 *  @see JSMessageInputViewStyle.
 */
