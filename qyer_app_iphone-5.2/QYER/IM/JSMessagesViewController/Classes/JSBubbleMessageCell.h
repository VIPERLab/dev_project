...
static NSInteger const kUserAvatarTag = 1000;
 ...
 */
@interface JSBubbleMessageCell : UITableViewCell<UIViewControllerTransitioningDelegate>
...
@property (weak, nonatomic, readonly) UIView *timestampBackView;
...
@property (weak, nonatomic, readonly) UIImageView *avatarMaskImageView;
 ...
 *  自定义视图右侧的TIPS
 */
@property (nonatomic, weak, readonly) UILabel *otherViewTipLabel;

@property (assign, nonatomic, readonly) JSBubbleMediaType mediaType;

@property (assign, nonatomic) id<JSBubbleMessageCellDelegate> delegate;
@property (assign, nonatomic) id<JSBubbleViewDelegate> bubbleViewDelegate;
