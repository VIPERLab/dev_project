...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    @catch (NSException *exception) {
        MYLog(@"pushViewController exception %@", exception);
    }
}
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated
{
    ...
    @catch (NSException *exception) {
        MYLog(@"popViewControllerAnimated exception %@", exception);
    }
    return vc;
}
...
- (void)paningGestureReceive:(UIPanGestureRecognizer *)recoginzer
{
    ...
    if (recoginzer.state == UIGestureRecognizerStateBegan) {
        ...
        for (UIView * viewww in self.topViewController.view.subviews) {
            [viewww setUserInteractionEnabled:YES];
        }
    ...
    if (_isMoving) {
        ...
        for (UIView * viewww in self.topViewController.view.subviews) {
            [viewww setUserInteractionEnabled:NO];
        }
