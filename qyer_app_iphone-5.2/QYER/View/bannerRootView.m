...
- (void)setMayLikePlaceModelArray:(NSArray *)mayLikePlaceModelArray
{
    ...
    for (int i = 0; i < imageCount; i++) {
        MayLikePlaceModel *placeMode = mayLikePlaceModelArray[i];
        ...
        shadeImage.userInteractionEnabled = NO;
        shadeImage.image = [UIImage imageNamed:@"mayLike_shade"];
        [backImage addSubview:shadeImage];
        
        //英文名
        UIFont *placeNameFont = [UIFont fontWithName:@"HiraKakuProN-W3" size:15];
...
- (void)setMayLikeBBSModelArray:(NSArray *)mayLikeBBSModelArray
{
    ...
    for (int i = 0; i < imageCount; i++) {
        MayLikeBBSModel *BBSMode = mayLikeBBSModelArray[i];
        ...
        //游记名
        UIFont *BBSNameFont = [UIFont fontWithName:@"HiraKakuProN-W3" size:15];
...
- (void)setMayLikeMyLastMinModelArray:(NSArray *)mayLikeMyLastMinModelArray
{
    ...
    for (int i = 0; i < imageCount; i++) {
        MayLikeMyLastMinModel *myLastMinMode = mayLikeMyLastMinModelArray[i];
        ...
        [_totalView addGestureRecognizer:discountTap];
        
        CGFloat totalViewW = 240;
        CGFloat totalViewX = 0;
        CGFloat totalViewY = 0;
        CGFloat totalViewH = 239;
        _totalView.frame = CGRectMake(totalViewX, totalViewY, totalViewW, totalViewH);
        [backView addSubview:_totalView];
        ...
        [_totalView addSubview:topImageView];
        ...
        //标题
        UIFont *myLastMinTitleFont = [UIFont fontWithName:@"HiraKakuProN-W3" size:14];
        ...
        CGSize myLastMinTitleSize = [myLastMinTitle.text sizeWithFont:myLastMinTitleFont constrainedToSize:CGSizeMake(225, 38) lineBreakMode:NSLineBreakByWordWrapping];
        ...
        [_totalView addSubview:myLastMinTitle];
        ...
        [_totalView addSubview:timeIcon];
        ...
        endTime.font = [UIFont fontWithName:@"HiraKakuProN-W3" size:14];
        ...
        [_totalView addSubview:endTime];
        
        
        //长按手势
        UILongPressGestureRecognizer *longPress = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(totalViewLongPress:)];
        longPress.minimumPressDuration = 0.2;
        [_totalView addGestureRecognizer:longPress];
    }
...
- (void)setType:(int)type
{
    ...
    UIFont *titleFont = [UIFont fontWithName:@"HiraKakuProN-W3" size:19];
    ...
    UIFont *subTitleFont = [UIFont fontWithName:@"HiraKakuProN-W3" size:12];
...
- (void)totalViewLongPress:(UILongPressGestureRecognizer *)gesturRecognizer{
    if (gesturRecognizer.state == UIGestureRecognizerStateBegan) {
        
        //长按遮罩
        UIView *backClickView = [[UIView alloc]initWithFrame:_totalView.bounds];
        backClickView.backgroundColor = [UIColor blackColor];
        backClickView.alpha = 0.3;
        backClickView.tag = 1010;
        [gesturRecognizer.view addSubview:backClickView];
    }
    if (gesturRecognizer.state == UIGestureRecognizerStateEnded) {
        UIView *backClickView = [[gesturRecognizer.view subviews] lastObject];
        if (backClickView.tag == 1010) {
            [backClickView removeFromSuperview];
        }
    }
}
/*
