...
- (void)drawMapRect:(MKMapRect)mapRect zoomScale:(MKZoomScale)zoomScale inContext:(CGContextRef)context {
    ...
    NSString *strPath = [overlay urlForPointWithX:tilex andY:tiley andZoomLevel:zoomLevel];
        
    NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:strPath]];
