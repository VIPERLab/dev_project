...
@interface RemindTimeViewController ()
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.text = [[_timeArray objectAtIndex:indexPath.row] objectForKey:@"description"];
...
- (NSIndexPath *)tableView:(UITableView *)tableView willSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [_delegate remindTimeViewControllerDidSelectTime:[_timeArray objectAtIndex:indexPath.row]];
    }
