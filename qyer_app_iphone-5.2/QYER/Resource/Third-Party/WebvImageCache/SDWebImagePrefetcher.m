...
- (void)reportStatus
{
    NSLog(@"Finished prefetching (%d successful, %d skipped, timeElasped %.2f)",
          [self.prefetchURLs count] - _skippedCount, _skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
