...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        CGFloat arrowW = 24;
        CGFloat arrowH = 24;
        CGFloat arrowX = topImageW - 8 - arrowW;
        ...
        _titleLable.text = @"拉沙耳光angienignisdnignie张";
        ...
        _countryNameLable.font = [UIFont systemFontOfSize:12];
        _countryNameLable.text = @"英国,";
        ...
        _cityNameLable.font = [UIFont systemFontOfSize:12];
        _cityNameLable.text = @"伦敦";
        ...
        starTextLable.font = [UIFont systemFontOfSize:9];
...
//    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:detailModel.description];
//    NSMutableParagraphStyle *paragraghStyle = [[NSMutableParagraphStyle alloc] init];
//    [paragraghStyle setLineSpacing:lineSpace];
//    [attributedString addAttribute:NSParagraphStyleAttributeName value:paragraghStyle range:NSMakeRange(0, detailModel.description.length)];
//    self.descriptionLable.attributedText = attributedString;
//    self.descriptionLable.lineBreakMode = NSLineBreakByTruncatingTail;
