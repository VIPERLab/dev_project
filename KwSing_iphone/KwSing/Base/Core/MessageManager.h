...
typedef enum eumMessage
{
    OBSERVER_ID_RESERVE
    ,OBSERVER_ID_APP
    ,OBSERVER_ID_MUSICLIB
    ,OBSERVER_ID_AUDIOSTATUS
    ,OBSERVER_ID_VIDEOSTATUS
    ,OBSERVER_ID_INVITESTATUS
    ,OBSERVER_ID_USERSTATUS
    ,OBSERVER_ID_MEDIA_SAVE_PROGRESS
    ,OBSERVER_ID_RTMP_PLAY_STATUS
    ,OBSERVER_ID_MY_MESSAGE
    ,OBSERVER_ID_MYOPUS
    ,OBSERVER_ID_EMIGRATED
    ,OBSERVER_ID_LIVEBROADCAST
