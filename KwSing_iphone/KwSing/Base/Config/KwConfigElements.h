...
//remote
#define NUM_CRITICAL_PROMPT_TIMES   "CriticalPromptTimes"
#define STR_COMMENT_ULR             "CommentUrl"
#define BOOL_COMMENT_ENABLE         "CommentEnable"
//local
#define NUM_SAVED_TIMES             "SavedTimes"
#define BOOL_NEED_PROMPT            "NeedPrompt"


#define AUDIO_EFFECT_GROUP          "AudioEffect"
#define VOLUME_SING                 "SingVolume"
#define VOLUME_ACCOMPANY            "AccompanyVolume"
#define ECHO_TYPE                   "EchoType"

#define CURRENT_LOCATE              "CurrentLocate"
#define CITY_LOCATE                 "CityLocate"
...
#define SPRING_MATCH_GROUP          "SpringMatchGroup"
#define SPRING_MATCH_ENABLE         "SpringMatchEnable"
#define SPRING_MATCH_JOIN           "SpringMatchJoin"
