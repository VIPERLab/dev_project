...
-(void)viewDidLoad
{
    ...
    [btn_ret addTarget:self action:@selector(onRetBtnClick) forControlEvents:UIControlEventTouchUpInside];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(songinfo)
    {
        ...
        [nowplay setPlayType:true];
        [nowplay setSongInfo:songinfo];
