...
public class PullToRefreshView extends LinearLayout {
	...
	private OnTouchEventBeforeListener mOnTouchEventBeforeListener;
	
	public interface OnTouchEventBeforeListener {
		void onTouchEventBefore();
	}
	...
	public void setOnTouchEventBeforeListener(OnTouchEventBeforeListener onTouchEventBeforeListener) {
		mOnTouchEventBeforeListener = onTouchEventBeforeListener;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		if(mOnTouchEventBeforeListener != null) {
			mOnTouchEventBeforeListener.onTouchEventBefore();
		}
		if (mLock) {
			return true;
		}
...
//				}
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderUpdateTextView.setText("更新于"+format.format(new Date()));
		mHeaderState = PULL_TO_REFRESH;
	}
