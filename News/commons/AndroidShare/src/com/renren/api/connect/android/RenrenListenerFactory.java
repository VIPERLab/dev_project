...
import com.renren.api.connect.android.Renren.CloseRenrenDialogListener;
...
class RenrenListenerFactory {
    ...
    static RenrenDialogListener genUserAgentFlowRenrenDialogListener(final Renren renren,
            final RenrenAuthListener listener, final String redirectUrl,final CloseRenrenDialogListener closeRenrenDialogListener,final RenrenAuthorCallback renrenAuthorCallback) {
        return new AbstractRenrenDialogListener() {
            ...
            private void authComplete(Bundle values) {
                ...
                if (accessToken != null) {
                    ...
                    try {
                        ...
                        //renren.saveUsername(renrenAuthorCallback,values);
                        listener.onComplete(values);
                        closeRenrenDialogListener.closeRenrenDialog();
                    } catch (Exception e) {
                        e.printStackTrace();
