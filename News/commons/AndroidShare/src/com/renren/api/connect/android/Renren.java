...
import com.ifeng.share.renren.RenrenAuthorCallback;
...
public class Renren implements Parcelable {
	...
	private SSO mSso;
	private RenrenDialog renrenDialog;
	/**
	...
	public void saveUsername(RenrenAuthorCallback renrenAuthorCallback,Bundle bundle){
		accessTokenManager.getUsername(renrenAuthorCallback,bundle);
	}
	/**
	...
	public void authorize(Activity activity, String[] permissions,
			final RenrenAuthListener listener, String redirectUrl) throws Exception{
	 ...
	 */
	/*public void authorize(Activity activity, final RenrenAuthListener listener) {
		this.authorize(activity, (String[])null, listener,null);
	}*/
	public void authorize(Activity activity, final RenrenAuthListener listener,RenrenAuthorCallback renrenAuthorCallback) throws Exception{
		this.authorize(activity, (String[])null, listener,renrenAuthorCallback);
	}
	/**
	 * 完成登录并获取sessionkey(User-Agent Flow)。
	 * 
	 ...
	 */
	public void authorize(Activity activity, String[] permissions,
			final RenrenAuthListener listener,RenrenAuthorCallback renrenAuthorCallback) throws Exception{
		if (this.isSessionKeyValid()) {
			listener.onComplete(new Bundle());
			return;
		}
		RenrenDialogListener rdl = RenrenListenerFactory
				.genUserAgentFlowRenrenDialogListener(this, listener,
						DEFAULT_REDIRECT_URI,new CloseRenrenDialogListener() {
							
							@Override
							public void closeRenrenDialog() {
								// TODO Auto-generated method stub
								renrenDialog.hide();
							}
						},renrenAuthorCallback);
	...
	private void authorize(Activity activity, String[] permissions,
		...
		if (activity.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			...
			renrenDialog=new RenrenDialog(activity, url, listener);
			renrenDialog.show();
		}
	}
	
	public interface CloseRenrenDialogListener{
		public void closeRenrenDialog();
	}
	/**
