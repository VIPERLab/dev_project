...
public class SSO {
    ...
    public void authorize(Activity activity, String[] permissions,
        ...
        if (!succeed) {
        	RenrenAuthorCallback renrenAuthorCallback = new RenrenAuthorCallback() {
            ...
            try {
				this.renren.authorize(activity, permissions, mAuthListener,renrenAuthorCallback);
			} catch (Exception e) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (error != null) {
                    if (error.equals("service_disabled")) {
                        ...
                        try {
							this.renren.authorize(mActivity, authPermissions, mAuthListener,renrenAuthorCallback);
						} catch (Exception e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
