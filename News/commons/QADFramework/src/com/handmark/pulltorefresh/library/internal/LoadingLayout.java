...
public class LoadingLayout extends FrameLayout {
	...
	static final int DEFAULT_ROTATION_ANIMATION_DURATION = 180;

	private final ImageView mHeaderImage;
	private final GifView mRefreshLoadingView;
	...
	private final Animation mRotateAnimationUp;
	private final Animation mRotateAnimationDown;
	...
	public LoadingLayout(Context context, final Mode mode, TypedArray attrs) {
		...
		android.view.ViewGroup.LayoutParams params = new android.view.ViewGroup.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		mRefreshLoadingView = (GifView) header.findViewById(R.id.attach);
		...
		mRotateAnimationUp = new RotateAnimation(0.0f, -180.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
		mRotateAnimationUp.setInterpolator(interpolator);
		mRotateAnimationUp.setDuration(DEFAULT_ROTATION_ANIMATION_DURATION);
		mRotateAnimationUp.setFillAfter(true);
		mRotateAnimationDown = new RotateAnimation(-180.0f, 0.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
		mRotateAnimationDown.setInterpolator(interpolator);
		mRotateAnimationDown.setDuration(DEFAULT_ROTATION_ANIMATION_DURATION);
	...
	public void releaseToRefresh() {
		...
		mHeaderImage.startAnimation(mRotateAnimationUp);
	}
	...
	public void refreshing() {
		mHeaderImage.setImageResource(R.drawable.filling);
		mRefreshLoadingView.setVisibility(View.VISIBLE);
		mRefreshLoadingView.reset();
		mHeaderText.setText(Html.fromHtml(/*mRefreshingLabel*/"正在载入..."));
	}
	...
	public void pullToRefresh() {
		mHeaderText.setText(Html.fromHtml(mPullLabel));
		mHeaderImage.startAnimation(mRotateAnimationDown);
	}
