...
import com.qad.app.BaseContext;
...
public class BaseFragmentActivity extends FragmentActivity {
	...
	protected void onDestroy() {
		super.onDestroy();
		// remove broadcast
		LinkedList<BaseBroadcastReceiver> copy = new LinkedList<BaseBroadcastReceiver>(
				managedReceivers);
	...
	protected void onStop() {
		super.onStop();
		// 判断isActivie==true解决在detail页按返回键同时按home键会导致发送两条end统计的问题
		if (!tool.isAppOnForeground() &&isActive == true) {
			isActive = false;
			onBackgroundRunning();
		}
	}
	 ...
	 * @param ids
	 * @param l
	 * @see practice.utils.ActivityTool#setOnClickListener(int[],
	 ...
	 * @param ids
	 * @param l
	 * @see practice.utils.ActivityTool#setOnTouchListener(int[],
	 ...
	 * @param message
	 * @param okListener
	 * @see practice.utils.ActivityTool#showConfirmDialog(java.lang.String,
	 ...
	 * @param listener
	 * @param views
	 * @see practice.utils.ActivityTool#setOnClickListener(android.view.View.OnClickListener,
	 *      android.view.View[])
	 */
