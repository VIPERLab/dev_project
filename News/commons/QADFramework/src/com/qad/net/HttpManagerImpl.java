...
class HttpManagerImpl implements IHttpManager {
	...
	public final static int SO_TIMEOUT = 5 * 1000;
	...
	private HttpResponse validResponse(HttpResponse response)
	    ...
	    // 目前日志采集接口的返回内容为空，状态码是204 No Content
...
//	}
	...
	public DefaultHttpClient getHttpClient() {
		...
		if (ApnManager.useProxy) {
			// set proxy on HttpClient, because on some devices, e.g. SamSung Note I, 
			// system proxy setting not work on HttpClient
			HttpHost proxy = new HttpHost(ApnManager.getProxy_server(),
					ApnManager.getProxy_port());
			httpclient.getParams().setParameter(ConnRoutePNames.DEFAULT_PROXY,
					proxy);
		}
//		if (shouldUseProxy()) {
//			//HttpClient set proxy
//			setProxy();
//		}else if(System.getProperties()!=null){
//			unsetProxy();
//		}
//		Log.e("Sdebug", "getHttpClient http.proxyHost=" + System.getProperty("http.proxyHost"));
		//ensure gzipablity
        ...
        httpclient.addResponseInterceptor(new HttpResponseInterceptor() {
            ...
            public void process(
                ...
                if (null != entity) {//目前在线日志的接口返回的entity为null
...
//		Log.e("Sdebug", "getHttpUrlConnection http.proxyHost=" + System.getProperty("http.proxyHost"));
//		if (shouldUseProxy()) {
...
//		        && !ApnManager.defaultProxyServer.equals("10.0.0.172")) {
...
//		System.setProperty("http.proxyHost", ApnManager.getProxy_server()+"");
//		System.setProperty("http.proxyPort", ApnManager.getProxy_port()+"");
//	}
	...
	public String getHttpText(String url) throws IOException {
		...
		String res = Streams.readAndClose(new InputStreamReader(Streams
				.buff(is)));
