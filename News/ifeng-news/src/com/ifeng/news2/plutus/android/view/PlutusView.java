...
public abstract class PlutusView extends FrameLayout implements PlutusAndroidListener<Object>, View.OnClickListener {
	...
	/**
	 * Constructor for the view, note that {@link PlutusCoreManager#qureyAsync(com.ifeng.news2.plutus.core.model.callable.PlutusCoreCallable, PlutusCoreListener) qureyAsync}
