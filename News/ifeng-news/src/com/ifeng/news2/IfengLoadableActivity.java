...
import com.ifeng.news2.IfengListLoadableActivity.PullDownRefreshListener;
...
public abstract class IfengLoadableActivity<T extends Serializable> extends
		LoadableActivity<T> {
	...
	@Override
	public void postExecut(LoadContext<?, ?, T> arg0) {
	...
	// 下拉刷新
	protected void pullDownRefresh(String url, final boolean ignoreExpired,
			final PullDownRefreshListener listener) {
