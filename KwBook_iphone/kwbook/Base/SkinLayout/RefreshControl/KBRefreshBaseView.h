...
@class KBRefreshBaseView;

typedef void (^BeginRefreshingBlock)(KBRefreshBaseView *refreshView);

@protocol KBRefreshBaseViewDelegate <NSObject>
@optional
- (void)refreshViewBeginRefreshing:(KBRefreshBaseView *)refreshView;
@end


@interface KBRefreshBaseView : UIView
{
        // 父控件
        __weak UIScrollView *_scrollView;
        // 代理
        __weak id<KBRefreshBaseViewDelegate> _delegate;
        // 回调
...
// 代理
@property (nonatomic, weak) id<KBRefreshBaseViewDelegate> delegate;
// 设置要显示的父控件
