            ...
            if (0 == row) {
                ...
                if (3 * row > [_hotSearchWords count]) {
                    ...
                    if (1 == [_hotSearchWords count] % 3) {
                        ...
                        [first_button setTitleColor:UIColorFromRGBValue(0x028bd0) forState:UIControlStateNormal];
                        ...
                        [second_button setTitleColor:UIColorFromRGBValue(0x028bd0) forState:UIControlStateNormal];
                    ...
                    if (nil == cell) {
                        ...
                        [third_button setTitleColor:UIColorFromRGBValue(0x028bd0) forState:UIControlStateNormal];
...
- (void) search : (NSString*) str_search_url{
    KS_BLOCK_DECLARE{
        void * buf(NULL);
        unsigned l(0);
        bool res = CHttpRequest::QuickSyncGet([str_search_url UTF8String], buf, l);
        if (res) {
            //请求成功
