...
{
    [[[[iToast makeText:showText] setGravity:iToastGravityCenter] setDuration:2000] show];
}
- (void) show{
...
- (void) show:(iToastType) type{
	...
	CGPoint point = CGPointMake(window.frame.size.width/2, window.frame.size.height/2);//这里的分析警告可以忽略 by haiping
