...
CGRect MoveRightRect(CGRect rect,float right)
{
    return CGRectMake(rect.origin.x + right, rect.origin.y, rect.size.width, rect.size.height);
}
CGRect MoveLeftRect(CGRect rect,float left)
{
    return CGRectMake(rect.origin.x - left, rect.origin.y, rect.size.width, rect.size.height);
}
CGRect MoveUpRect(CGRect rect,float up)
{
    return CGRectMake(rect.origin.x , rect.origin.y + up, rect.size.width, rect.size.height);
}
CGRect MoveDownRect(CGRect rect,float down)
{
    return CGRectMake(rect.origin.x , rect.origin.y - down, rect.size.width, rect.size.height);
}
