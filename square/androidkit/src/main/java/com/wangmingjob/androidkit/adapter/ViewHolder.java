...
public class ViewHolder {
	...
	/**
	 * Set Image with request url(use volley library's ImageLoader)
	 *
	 * @param viewId
	 * @param requestUrl
	 ...
	 * @return
	 */
	public ViewHolder setImageUrl(int viewId, String requestUrl, int defaultImageResId, int errorImageResId) {
		ImageView view = retrieveView(viewId);
		RequestManager.getImageLoader().get(requestUrl, ImageLoader.getImageListener(view, defaultImageResId, errorImageResId));
		return this;
	}
